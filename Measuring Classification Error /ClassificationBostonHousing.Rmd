...
# Training and Testing Creation Set Code
```{r }
library(ggplot2)
library(caret)
...
# Function to create Data Partition into Traiing and Testing Set
####### Now We can apply the function to 
######$Create the testing and Training set
head(BostonH)

Boston_H_train_test = Create_Trainnig_Testing_Data(BostonH,prop=0.8 )
train<-Boston_H_train_test$train_set
vali = Boston_H_train_test$test_set
```
...
caret::confusionMatrix(as.factor(ifelse(pred_t > 0.5,1,0)), as.factor(train$CAT..MEDV))
